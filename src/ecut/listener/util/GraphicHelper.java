...
public final class GraphicHelper {
	 ...
	 */
	public static String create( final int n , boolean isSinaean , final int width,final int height , OutputStream output , final int interfere ){
		// 创建"画板"
	 ...
	 * @param n 线条数目
	 */
	private static void drawRandomLine( final Graphics graphic ,final int width , final int height , final int length , final int  n ) {
		// 在 "画板"上生成干扰线条
		for (int i = 0; i < n ; i++) {
	 ...
	 * @return
	 */
	private static String drawCharacters( final Graphics graphic ,final int width , final int height ){
		String s = "" ;
	 ...
	 * @return 返回验证码字符串
	 */
	private static String letters( final int n ){
		BUFFER.setLength( 0 );
		for( int i = 0 ; i < n  ; i++ ){
	...
	protected static void gbk(final int width,final int height,final String imgType,OutputStream output) throws IOException{
