...
public final class DateHelper {
	 ...
	 * @return
	 */
	public static java.sql.Date cast( java.util.Date ud ) {
		if( ud != null ){
	 ...
	 * @return 时间对应的字符串
	 */
	public static String timeFormat( java.util.Date date ) {
	 ...
	 */
	public static java.util.Date parseDate( String source ) {
